...
def download_stock_returns(ticker:str='SP500', start_date:str='1990-01-01'):
    ...
    if ticker == 'SP500':
        ...
        url = 'https://financialmodelingprep.com/api/v3/historical-price-full/index/^STOXX'
    elif ticker == 'NIKKEI':
        url = 'https://financialmodelingprep.com/api/v3/historical-price-full/index/^N225'
    else:
